...
" Plugins
call plug#begin()
       Plug 'preservim/nerdtree' "Arbol
       Plug 'jiangmiao/auto-pairs' "Completado parentesis
       Plug 'vim-airline/vim-airline' "Barra inferior
       Plug 'vim-airline/vim-airline-themes' "Temas Barra
       Plug 'neoclide/coc.nvim', {'branch': 'release'} "Autocompletado
       Plug 'chrisbra/colorizer' "subrayado de colores
       Plug 'KabbAmine/vCoolor.vim' "colores picker
       Plug 'arcticicestudio/nord-vim' "tema
       Plug 'ryanoasis/vim-devicons' "Iconos en Nerdtree
       Plug 'jalvesaq/Nvim-R' "R en Vim
call plug#end()
"R
let R_assign = 2 " dos guion bajo para <-
:map <C-r> \lj
